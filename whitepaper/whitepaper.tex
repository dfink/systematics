...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=0.6\linewidth]{plots/option3v3_lineEval.eps}
    \vspace{-0.5cm}
  \end{center}
...
We evaluate the mixed observation mode in the following. 

\dots Exposure maps, integrated over precession period \dots
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=0.9\linewidth]{plots/exposure_maps.ps}
    \vspace{-0.5cm}
  \end{center}
  \caption{All sky exposure maps for modified survey
  strategy option 1, 2, and 3 (left column) and fraction of
  exposure maps relative to standard survey mode (right
  column). The exposure maps on left were divided by
  4.1$\times 10^9 cm^2/s$, which is roughly the exposure at
  the Galactic center for the 50 deg survey mode at ~100
  GeV. }
  \label{fig:option}
\end{figure}

\dots Exposure maps, integrated over 24 hours (or 3 hours or whatever) \dots
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=0.37\linewidth, angle=-90]{plots/exposure_pixel_hist_perday.ps}
    \includegraphics[width=0.37\linewidth, angle=-90]{plots/exposure_exp_hist_perday.ps}
    \vspace{-0.5cm}
  \end{center}
  \caption{Left panel: daily sky coverage with different range of exposure time normalized to the mean value of the exposure map of each day (in total 55 days to complete on orbit precession period). Right panel: in stead the sky coverage, we plot the fractional exposure time relative to the mean value of the exposure map of each day.}
  \label{fig:option}
\end{figure}

\dots Histogram for uniformity \dots
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=0.37\linewidth, angle=-90]{plots/option1_survey_hist.ps}
    \includegraphics[width=0.37\linewidth, angle=-90]{plots/option2_option3_hist.ps}
    \vspace{-0.5cm}
  \end{center}
  \caption{Histogram on sky pixels of fractional exposure normalized to standard survey strategy. Left panel compares the modified strategy option 1 to the standard survey strategy, and the right panel shows the modified strategy option 1 relative to option 3. }
  \label{fig:option}
\end{figure}

\dots energy resolution in different sky regions (optional) \dots

\dots Figure of merit \dots
I thought we can just use your plot, but let me regenerate this with all the three strategies.

\dots theta distribution at GC (optional) \dots
Do we want this plot? I can do it.
