...
specific point in time, the acctually observed significance has to lie outside
of the predicted
...
\begin{figure}[t]
  ...
  times where the GC was within $10^\circ$ or between $10^\circ$ to $45^\circ$
...
$11.1\%$ and $10.0\%$. Apart from the characteristics at the GC, these modes
...
\begin{table}[t]
  ...
  sky) and exposure of GC for different observation profiles in comparison.
...
In Fig.~\ref{fig:transhist} we show how the exposure of different variable
source types from the 1FAV is affected by changing from survey to mixed mode
observations. For the different source classes, we show the fraction of
sources which would loose in exposure by than $50\%$ (red), which would gain
more than $50\%$ of exposure (green), and which remain relatively uneffected
(black). \textbf{(MENG: which source class is most effected? How much is this
effected? Do we care?)}
