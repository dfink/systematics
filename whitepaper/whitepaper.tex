...
sky does the exposure drop by more than a factor of three relative to normal
survey mode.
...
fraction of sources that would lose in exposure by than
$50\%$ (red), which would gain more than $50\%$ in exposure
(green), and which remain relatively unaffected (black). For
option1v2, we have 25 sources that would receive more than
...
comparable (50-150\%) exposure time for option1v2 and the standard
survey mode.  In Table~\ref{tab:transsource}, we compare for the
three modified strategies the fraction of transient sources
that would obtain $>150\%$ exposure, $<50\%$ exposure, and $50-150\%$. As we see from the Table, option3v3
provides a comparable number of sources with $>150\%$ exposure,
but 50\% (33\%) smaller sample of sources with $<50\%$
exposure for option1v2 (option2v2).
