...
hole~\cite{Gillessen:2011aa, Phifer:2013taa}. Although the predicted intensity
of gamma-ray emission from the G2 cloud encounter is not clear yet, Fermi as
the only gamma-ray space telescope covering from MeV to TeV energy range,
should produce the most detailed monitoring before, during and after the
closest approach of G2 to the central black hole with enhanced sensitivity as
a bonus of the modified survey strategy. Fermi's observation would provide
