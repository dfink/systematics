...
\item{\bf Fermi can do it: a modified survey strategy can obtain a decisive
  ...
  (Fig. \ref{fig:projection}).  Because of Poisson fluctuations, a given
  realization of future data will achieve a significance between 2.5 and
  5$\sigma$ 68\% of the time, and between 1.5 and 6.5$\sigma$ 95\% of the
  time.  A clear separation the signal hypothesis from the null hypothesis
  ...
  question unresolved.  We cannot permit that to happen.
...
\item{\bf A change is not bad for other science.}  There will be winners and
  ...
  observable.  Furthermore, as see in Fig. \ref{fig:coverage}, roughly half
...
\item{\bf It looks good for an extension of the mission.}  Fermi will soon
  pass the milestone of its 5-year nominal mission, and an extension until
  2016 has already been granted.  While there are many
  reasons to grant additional extensions, it is helpful to consider options
  that improve something faster than sqrt(time).

\end{itemize}

For all of these reasons, we advocate a change in the survey strategy, as soon
as possible.
(Should we specifically advocate option 3 here?)  
...
regret this opportunity to pursue it aggressively. 
