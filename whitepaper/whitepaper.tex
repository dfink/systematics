...
comparable exposure time for option1v2 and the standard
survey mode.  In Tab.~\ref{tab:transsource}, we compare the
three modified strategies the fraction of transient sources
would obtain $>150\%$ exposure, $<50\%$ exposure, and fairly
unaffected sources. As we see from the Table, option3v3
provide comparable number of sources with $>150\%$ exposure,
