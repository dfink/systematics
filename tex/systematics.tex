...
% Contamination due to neglected rocking angle cut (GC events from zrock>52
% etc?)
% What happens for P7SOURCE_V6?
\medskip
...
% Indication for correlation with $Z$ angle or statistical fluke
...
% In Fig.~\ref{fig:rock}, we show the rocking angle distribution (i.e. the angle
% of the spacecraft Z-axis from zenith) of the GC line events.
...
\begin{figure}
  ...
  \caption{The rocking angle of the Galactic center line events (positive
  values indicate a rock angle toward the north from zenith)-- \textbf{need to
  add red and blue to this plot}...  }
  \label{fig:rock}
\end{figure}
