...
energy remapping model as possible explanation for fake signals.  Finally in
...
Fig.~6 suggests that the TS values observed in some panels in case of
...
\begin{figure}
  ...
  \caption{Incidence angle $\theta$ vs. log $E$ for $Z >
    110\degree$.  Dark green points are \texttt{FRONT} only
...
\begin{figure}
  ...
  \caption{Time histogram (1-day bins) of GC and Earth limb line
  events (upper panel) and all limb events (lower panel).  The Earth limb line
  events are
...
> 110\degree$ for both \texttt{FRONT} and \texttt{BACK}
converting events. 
...
% 110\degree$) \Fermi\ observes the sky with very little
...
evidence for a gamma-ray line feature at $\sim$130 GeV
towards the GC using data from
\Fermi-LAT~\citep{Weniger:2012,linepaper}. While
\Fermi\ accumulates additional data and increases the exposure of the signal
region,
a thorough investigation of any LAT
systematics which could possibly induce a fake line-like
signal at 130 GeV is urgently required. In this paper, we have
-- based on the publicly available information --
performed a comprehensive check of peculiarities of the 130
GeV line photons from the GC, and various hypothesis of
instrumental effects which could possibly induce a 130 GeV
line feature have been tested.
\medskip

Since the line is most significant at the GC, the first
...
GeV were incorrectly remapped to 130 GeV. {\em We conclude
...
geometrical reasons. We have also compared time evolution of
...
earth limb photons from 4 yrs publicly available
...
the effect of miscalibrated photon energy around 130 GeV
