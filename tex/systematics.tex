...
below) {\bf (Move discussion here?)}entered the FOV of the LAT. In
...
circle, {\bf (Do you mean the full ecliptic plane?)} but only the intersection with the Galactic disk
...
\begin{figure}
  ...
  for the GC line. {\bf green and red???}}
...
{\bf decide what to do with this...}
