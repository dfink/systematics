...
gamma-ray burst follow-up observations.  
...
azimuthal angle of incidence with respect to the $+x$ axis.  {\bf I think this was wrong
...
below) {\bf (under = near?  Move discussion here?)}entered the FOV of the LAT. In
...
\begin{figure}
  ...
  \caption{Energy distribution in various bright regions {\bf (say event
      samples instead of bright regions?) }as
...
\begin{figure*}
  ...
  as in Fig.~\ref{fig:phiThetaDist}.  {\bf  There are a lot at$\ell=70$ does
    this mean anything ???}}
  \label{fig:time_phi}
\end{figure*}
...
sources in the GC may be unusualy hard. If these high energy
...
suspicious trends at 130 GeV as a function of the event
...
resulting $TS$ values as a function of the line energy are
