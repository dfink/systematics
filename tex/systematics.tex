...
from the work of Weniger~\citep{Weniger:2012}, which grew
...
correct, this should allow extraction of the DM signal with
...
have provoked theorists to try to reconcile the observations
...
GeV~\cite{galaxyclusters}.  Neither of these would stand on
...
If one believes the statistical significance of this line
feature, it motivates a search for systematic errors in the
...
In order to test suspecious spectral feature at $\sim$130
GeV from LAT instrument, a signal with smooth reference
spectrum extended at least to this energy is
required. Nearly grazing incidence cosmic rays (CR) initiate
cascades in the Earth's atmosphere, making gamma-rays which
can penetrate the upper thin layer of atmosphere without
strong attenuation and produce a bright gamma-ray horizon
with featureless spectrum~\citep[e.g.][and reference
  therein]{FermiLimb}, sometimes referred as ``Earth limb
photons'' or ``albedo photons''.
