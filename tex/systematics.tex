...
periods of high rocking angle, as it is geometrically impossible to see limb
...
(Figs.~\ref{fig:phiThetaDist} and~\ref{fig:time_phi}).  In short, none of the
figures reveals suspicious trends or correlations, or indicate in any way that
...
By selecting a small subset (6\%) of the limb data with low
