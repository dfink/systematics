...
lists and spacecraft parameter files. In this paper, we
search for suspicious trends that could indicate a spurious
signal at 130 GeV.  In particular, the Earth limb photons
provide a smooth reference spectrum for null tests.  We
examine these events in detail and compare with the line
photons from the Galactic center.
%But all of this work depends on
%the question:
%(What was the question?)

%accretion of a dwarf galaxy.
In \Refsec{130GeV} we briefly define the key parameters to
