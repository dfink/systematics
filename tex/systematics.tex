...
Throughout, we use 207 weeks of \texttt{P7CLEAN\_V6} events, with the
good-time-interval cut \texttt{DATA\_QUAL==1}, however without cuts on the
zenith angle $Z$ or rocking angle \zrock. We checked that our results remain
qualitatively the same when using instead \texttt{P7SOURCE\_V6} events or when
applying \texttt{LAT\_CONFIG==1}. \textbf{(check!)} 
