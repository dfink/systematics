...
$2.9\sigma$.
A further tuning of the $\theta$-range yields TS values up to $TS=16.6$ for
$25^\circ<\theta<53^\circ$, such that after trials the overall statistical
significance for a line in the $\theta<60^\circ$ Earth limb data is
$\gtrsim3.0\sigma$. 
For comparison, the lower panel of Fig.~\ref{fig:spectra2} shows a fit to the Galactic center energy
...
$25^\circ<\theta<53^\circ$ from the GC region (from Reg4~\cite{Weniger:2012}),
we obtain $TS=5.1$ ($TS=10.1$) for the Galactic center signal. 
