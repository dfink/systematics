...
reason) for $30\degree < \theta < 45\degree$ might explain
the limb photons, but would also produce a line in the other samples of
Tab.~\ref{tab:regions} or in all corresponding panels
of~Fig.~\ref{fig:polarPlotsAll}.  No such line is seen outside of the
GC.\medskip
