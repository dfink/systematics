...
photons, all non-limb non-GC photons) also show nothing.  The GC has a hard
...
to 130 GeV, there would not be enough to explain the GC signal.
...
evidence that the distribution of line events deviates from expections.

\emph{There are excess line events in the limb data for some incidence angles.}
For a small subset of the limb data with large zenith angle (when the limb may
...
2008, this
provides $\sim$250 hours total livetime of the Earth limb
photons~\cite{FermiLimb}. This data set has allowed the study of the spatial
...
The additional limb data provided by LEO would
...
In this Appendix, we check a couple of possible function
